...
Beyond post-training compression, future models could adopt MatShrink's reduced weight structures from the outset, training directly on the smaller parametrization and achieving better parameter efficiency from scratch.
