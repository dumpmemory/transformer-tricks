...
A CUTLASS-backed fused \texttt{RMSNorm+linear} kernel targeting vLLM~\citep{vLLM} integration is under active development, directly extending the A100 prototype of Appendix~\ref{app:a100}; the goal is to preserve the fusion savings at Llama-family production scales where the Triton prototype is limited by matmul codegen quality. Further integration targets include
