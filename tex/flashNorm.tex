...
normalization weights of RMSNorm and LayerNorm; see Appendix~\ref{app:additional-notes} for an extended comparison to \citet{remove-norm2} and the OLMo line.
